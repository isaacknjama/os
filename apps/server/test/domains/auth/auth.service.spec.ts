...
describe('AuthService', () => {
  ...
  beforeAll(async () => {
    ...
    mockTokenService = {
      ...
      verifyAccessToken: mock().mockResolvedValue({
  ...
  describe('loginUser', () => {
    it('should login user with phone and PIN successfully', async () => {
      ...
      expect(mockTokenService.generateTokens).toHaveBeenCalledWith(testUser);
  ...
  describe('authenticate', () => {
    ...
    it('should throw UnauthorizedException for invalid token', async () => {
      ...
      mockTokenService.verifyAccessToken.mockRejectedValueOnce(
