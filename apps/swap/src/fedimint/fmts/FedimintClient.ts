...
export class FedimintClient {
  ...
  private async postWithFederationId<T>(
    ...
    if (effectiveFederationId === '') {
      throw new Error(
        'Must set active federation id before or while making a request',
      );
    }
  ...
  private async postWithGatewayIdAndFederationId<T>(
    ...
    if (effectiveFederationId === '' || effectiveGatewayId === '') {
      throw new Error(
        'Must set active federation and gateway id before or while making a request',
      );
    }
